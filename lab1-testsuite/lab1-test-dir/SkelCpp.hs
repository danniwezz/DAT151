...
transDecl x = case x of
  DeclConst type_ -> failure x
  DeclConstId type_ id -> failure x
  Decl type_ id -> failure x
  DeclsConst type_ id ids -> failure x
  Decls type_ id ids -> failure x
  DeclInit type_ id exp -> failure x
  DeclInitConst type_ id exp -> failure x
transStm :: Stm -> Result
