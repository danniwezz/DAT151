...
Def : Type Id '(' ListArg ')' '{' ListStm '}' { AbsCpp.DFun $1 $2 $4 (reverse $7) }
    ...
    | Type Id '=' Exp ';' { AbsCpp.DStat $1 $2 $4 }
...
Decl :: { Decl }
Decl : 'const' Type { AbsCpp.DeclConst $2 }
     | 'const' Type Id { AbsCpp.DeclConstId $2 $3 }
     | Type Id { AbsCpp.Decl $1 $2 }
     | 'const' Type Id ',' ListId { AbsCpp.DeclsConst $2 $3 $5 }
     | Type Id ',' ListId { AbsCpp.Decls $1 $2 $4 }
     | Type Id '=' Exp { AbsCpp.DeclInit $1 $2 $4 }
     | 'const' Type Id '=' Exp { AbsCpp.DeclInitConst $2 $3 $5 }
Stm :: { Stm }
