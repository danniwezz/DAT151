...
instance Print Def where
  prt i e = case e of
    ...
    DStat type_ id exp -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "="), prt 0 exp, doc (showString ";")])
...
instance Print Decl where
  prt i e = case e of
    DeclConst type_ -> prPrec i 0 (concatD [doc (showString "const"), prt 0 type_])
    DeclConstId type_ id -> prPrec i 0 (concatD [doc (showString "const"), prt 0 type_, prt 0 id])
    Decl type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id])
    DeclsConst type_ id ids -> prPrec i 0 (concatD [doc (showString "const"), prt 0 type_, prt 0 id, doc (showString ","), prt 0 ids])
    Decls type_ id ids -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString ","), prt 0 ids])
    DeclInit type_ id exp -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "="), prt 0 exp])
    DeclInitConst type_ id exp -> prPrec i 0 (concatD [doc (showString "const"), prt 0 type_, prt 0 id, doc (showString "="), prt 0 exp])
