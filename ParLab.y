...
Def : Type Id '(' ListArg ')' '{' ListStm '}' { AbsLab.DFun $1 $2 $4 (reverse $7) }
    ...
    | Type Id '=' Exp ';' { AbsLab.DStat $1 $2 $4 }
...
Decl :: { Decl }
Decl : 'const' Type { AbsLab.DeclConst $2 }
     | 'const' Type Id { AbsLab.DeclConstId $2 $3 }
     | Type Id { AbsLab.Decl $1 $2 }
     | 'const' Type Id ',' ListId { AbsLab.DeclsConst $2 $3 $5 }
     | Type Id ',' ListId { AbsLab.Decls $1 $2 $4 }
     | Type Id '=' Exp { AbsLab.DeclInit $1 $2 $4 }
     | 'const' Type Id '=' Exp { AbsLab.DeclInitConst $2 $3 $5 }
Stm :: { Stm }
