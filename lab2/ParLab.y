...
Stm : Exp ';' { AbsLab.SExp $1 }
    | Type ListId ';' { AbsLab.SDecls $1 $2 }
    | Type Id '=' Exp ';' { AbsLab.SInit $1 $2 $4 }
...
Exp15 : 'true' { AbsLab.ETrue }
      ...
      | '(' Exp ')' { $2 }
Exp14 :: { Exp }
Exp14 : Id '(' ListExp ')' { AbsLab.EApp $1 $3 }
      | Id '++' { AbsLab.EPostIncr $1 }
      | Id '--' { AbsLab.EPostDecr $1 }
      | Exp15 { $1 }
Exp13 :: { Exp }
Exp13 : '++' Id { AbsLab.EPreIncr $2 }
      | '--' Id { AbsLab.EPreDecr $2 }
      | Exp14 { $1 }
Exp12 :: { Exp }
...
Exp11 : Exp11 '+' Exp12 { AbsLab.EPlus $1 $3 }
      ...
      | Exp12 { $1 }
Exp9 :: { Exp }
Exp9 : Exp10 '<' Exp10 { AbsLab.ELt $1 $3 }
     | Exp10 '>' Exp10 { AbsLab.EGt $1 $3 }
     | Exp10 '<=' Exp10 { AbsLab.ELtEq $1 $3 }
     | Exp10 '>=' Exp10 { AbsLab.EGtEq $1 $3 }
     | Exp10 { $1 }
Exp8 :: { Exp }
Exp8 : Exp9 '==' Exp9 { AbsLab.EEq $1 $3 }
     | Exp9 '!=' Exp9 { AbsLab.ENEq $1 $3 }
     | Exp9 { $1 }
Exp4 :: { Exp }
...
Exp2 :: { Exp }
Exp2 : Id '=' Exp2 { AbsLab.EAss $1 $3 } | Exp3 { $1 }
Exp :: { Exp }
Exp : Exp1 { $1 }
Exp1 :: { Exp }
Exp1 : Exp2 { $1 }
...
ListExp : {- empty -} { [] }
        ...
        | Exp ',' ListExp { (:) $1 $3 }
Type :: { Type }
Type : 'bool' { AbsLab.Type_bool }
     | 'int' { AbsLab.Type_int }
     | 'double' { AbsLab.Type_double }
     | 'void' { AbsLab.Type_void }
ListId :: { [Id] }
